        ...
        <div class="modal-body row">
          <div class="col-md-4">
            ...
            <p class="icons" @click="bookData.willRead = !bookData.willRead">
              <span
                class="fa fa-book"
                :style="bookData.willRead ? 'color : pink;' : 'color : black;'"
              ></span>
              {{bookData.willRead ? 'In will read list' : 'Add Will read'}}
            </p>
            <p class="icons" @click="bookData.alreadyRead = !bookData.alreadyRead">
              ...
              ></span>
              {{bookData.alreadyRead ? 'In already read list' : 'Add already Read'}}
            </p>
          </div>
          <div class="col-md-8">
            <div class="card-body">
              ...
              <hr />
              <p>
                <a :href="bookData.previewLink" target="_blank">Click for preview of book</a>
              </p>
              <p>
                <a :href="bookData.infoLink" target="_blank">Click for the more information</a>
              </p>
            </div>
          </div>
        </div>
